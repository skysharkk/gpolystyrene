...
if __name__ == '__main__':
    ...
    ui_table = AcadSelectedElements(window.tableWidget_2, window.pushButton_4, window.pushButton_7)
    ...
    def format_table_data(data):
        formatted_list = [
            ['Поз.', 'Обозначение', 'Наименование', 'Кол.', u'Объем ед.м\u00b3', 'Примечание'],
    ...
    def select_items():
        ...
        if params and scale_value:
            ...
            ui_table.add_data_to_table(create_table_data(params, data, scale_value))
